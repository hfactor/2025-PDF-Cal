// A4 One Line Per Day Calendar for 2025
// A simple, clean calendar with one line for each day of the year
...
#let font-size-date = 6pt  // Smaller font
#let font-size-month = 7pt  // Smaller font
#let font-size-year = 12pt  // Smaller font

// A4 dimensions - use full page
...
// Column layout - use more space efficiently
#let num-columns = 3  // Back to 3 columns for better width usage
#let column-width = content-width / num-columns
#let lines-per-column = 122  // 365 / 3 = 121.67, so 122 lines per column
#let line-height = 2.4mm  // Increased line height to use more bottom space
...
#let a4-calendar() = {
  ...
  // Split days into 3 columns for better space usage
