// A4 2-Page Calendar for 2025 - 6 months per page, 2 columns
...
// 2-page layout: 6 months per page, 6 columns
#let months-per-page = 6
#let num-columns = 6  // 6 columns for 6 months
...
#let line-height = 9.44mm  // Adjusted to fit in 2 pages
